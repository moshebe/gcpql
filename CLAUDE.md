...
**For full agent context (layout, conventions, build, test), see [AGENTS.md](AGENTS.md).** That file is written for all AI coding agents (Cursor, Claude, Cline, Aider, etc.).
